...
test('admin asset query keys and page version advance together', () => {
  assert.equal(version.version, '20260913-1');
  assert.match(adminHtml, /const pageVersion = '20260913-1'/);
  assert.match(adminHtml, /admin\.css\?v=20260913-1/);
  assert.match(adminHtml, /admin\.js\?v=20260913-1/);
