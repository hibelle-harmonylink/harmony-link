...
test('laptop hero uses non-overlapping copy and image tracks with matching cache keys', () => {
  assert.equal(version.version, '20260916-5');
  assert.match(homepage, /const pageVersion = '20260916-5'/);
  assert.match(homepage, /homepage-ui\.css\?v=20260916-5/);
  assert.match(homepage, /script\.js\?v=20260916-5/);
