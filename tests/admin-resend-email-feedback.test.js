...
test('admin asset versions advance together for the resend UX', () => {
  assert.equal(version.version, '20260915-1');
  assert.match(adminHtml, /const pageVersion = '20260915-1'/);
  assert.match(adminHtml, /admin\.css\?v=20260915-1/);
  assert.match(adminHtml, /admin\.js\?v=20260915-1/);
});
