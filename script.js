...
if(communitySection){
  ...
  if(communityHeading){communityHeading.dataset.ko='원하는 이용 경로를 선택하세요';communityHeading.dataset.en='Choose the Path That Fits You';communityHeading.textContent=currentLanguage==='ko'?'원하는 이용 경로를 선택하세요':'Choose the Path That Fits You';}
