...
partnerCenter.querySelector('.partner-center-card').insertAdjacentHTML('beforeend', `<div class="partner-upgrade-guide"><button class="partner-guide-toggle" type="button" aria-expanded="false" aria-controls="partnerGuideDetails"><span><small>PARTNER START GUIDE</small><strong data-ko="로그인부터 파트너 등급 이용까지" data-en="From sign-in to partner access">로그인부터 파트너 등급 이용까지</strong></span><b aria-hidden="true">＋</b></button><div class="partner-guide-details" id="partnerGuideDetails" hidden><p data-ko="아래 순서대로 진행하면 신청과 승인 상태를 쉽게 확인할 수 있습니다." data-en="Follow these steps to apply, receive approval, and access your partner resources.">아래 순서대로 진행하면 신청과 승인 상태를 쉽게 확인할 수 있습니다.</p><ol><li><b>01</b><span data-ko="가입·로그인" data-en="Join or sign in">가입·로그인</span><small data-ko="Google 또는 카카오 계정으로 시작합니다." data-en="Start with Google or Kakao.">Google 또는 카카오 계정으로 시작합니다.</small></li><li><b>02</b><span data-ko="입점 파트너 신청" data-en="Partner application">입점 파트너 신청</span><small data-ko="업체 또는 개인 강사 신청서를 제출합니다." data-en="Submit a company or instructor application.">업체 또는 개인 강사 신청서를 제출합니다.</small></li><li><b>03</b><span data-ko="관리자 검토·승인" data-en="Review and approval">관리자 검토·승인</span><small data-ko="승인 후 FREE 등급과 안내메일을 받습니다." data-en="Receive Free Partner status and an email after approval.">승인 후 FREE 등급과 안내메일을 받습니다.</small></li><li><b>04</b><span data-ko="등급 선택·변경" data-en="Choose or upgrade tier">등급 선택·변경</span><small data-ko="필요에 따라 BASIC 또는 PREMIUM으로 변경합니다." data-en="Choose BASIC or PREMIUM as needed.">필요에 따라 BASIC 또는 PREMIUM으로 변경합니다.</small></li><li><b>05</b><span data-ko="다시 로그인·자료 이용" data-en="Sign in again and access">다시 로그인·자료 이용</span><small data-ko="다시 로그인하면 등급별 자료를 이용합니다." data-en="Sign in again to access tier resources.">다시 로그인하면 등급별 자료를 이용합니다.</small></li></ol><div class="partner-guide-actions"><a class="btn btn-primary" href="https://forms.gle/pF4xy5Jz4ycVouKo9" target="_blank" rel="noopener noreferrer"><span data-ko="파트너 신청서 작성" data-en="Apply as a Partner">파트너 신청서 작성</span><b>✓</b></a></div></div></div>`);
