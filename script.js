...
const adRooms={
  ...
  community:{ko:'협력 업체',en:'Community Partners',label:'COMMUNITY PARTNER',slots:4,items:[{name:'AALEAC',displayNameKo:'아시안 아메리칸 사법 경찰자문위원회',displayNameEn:'Asian American Law Enforcement Advisory Council',copy:'아시안 커뮤니티와 사법기관의 소통과 협력을 지원합니다.<br>연락처 aaleac.org',copyEn:'Supporting communication and cooperation between Asian American communities and law enforcement.<br>Contact aaleac.org',url:'https://aaleac.org/',image:'assets/partners/aaleac-shield.png?v=20260720-46'}]},
...
const specialtyPopupCopy={
  digital:{ko:'AI와 스마트폰을 실생활에서 자신 있게 활용하도록 돕는 맞춤형 디지털 교육입니다.<br>연락처 929-603-0052',en:'Practical digital education for using AI and smartphones with confidence in daily life.<br>Contact 929-603-0052'},
  english:{ko:'시간과 장소의 제약 없이 수준과 목표에 맞춰 진행하는 1:1 실용 화상영어입니다.<br>연락처 929-603-0052',en:'Personalized one-to-one practical English lessons tailored to each learner’s level and goals.<br>Contact 929-603-0052'},
  melody:{ko:'노래·발성·호흡과 다양한 음악 활동으로 마음과 공동체를 잇는 힐링 프로그램입니다.<br>연락처 929-603-0052',en:'A healing music program connecting hearts and community through singing, breathing, and music activities.<br>Contact 929-603-0052'}
};
const promotionNews=[
