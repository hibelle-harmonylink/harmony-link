...
const footerBottom=document.querySelector('.footer-bottom');if(footerBottom&&!document.querySelector('.footer-social-panel'))footerBottom.insertAdjacentHTML('beforebegin',`<div class="container footer-social-panel"><div><p class="eyebrow">SOCIAL MEDIA</p><h3>Harmony Link · Hibelle Consulting</h3><span data-ko="디지털 교육과 화상영어, 새로운 프로그램 소식을 소셜미디어에서도 만나보세요." data-en="Follow our digital education, online English, and new program updates on social media.">디지털 교육과 화상영어, 새로운 프로그램 소식을 소셜미디어에서도 만나보세요.</span></div><nav aria-label="소셜미디어"><a href="https://www.instagram.com/hibelleconsulting/" target="_blank" rel="noopener noreferrer" class="instagram"><b>◎</b><span>Instagram</span><small>@hibelleconsulting</small></a><a href="https://www.threads.net/@hibelleconsulting" target="_blank" rel="noopener noreferrer" class="threads"><b>@</b><span>Threads</span><small>@hibelleconsulting</small></a></nav></div>`);
