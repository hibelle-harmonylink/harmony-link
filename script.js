...
learnerApplicationModal.innerHTML=`<div class="partner-modal-backdrop" data-learner-close></div><div class="partner-modal-panel"><div class="partner-modal-head"><div><p>HARMONY LINK LEARNING</p><h2 data-ko="교육 신청 안내" data-en="Learning Request">교육 신청 안내</h2></div><button class="partner-modal-close" type="button" data-learner-close aria-label="닫기">×</button></div><div class="partner-modal-scroll learner-flyer-scroll"><input class="learner-flyer-state" id="learnerFlyerState" type="checkbox"><label class="partner-flyer-toggle" for="learnerFlyerState"><img src="assets/partners/learner-application-20260718.png" alt="하모니링크 교육 신청 안내 전단지"><span class="flyer-expand-label" data-ko="전단지 클릭해서 크게 보기" data-en="Click to enlarge flyer">전단지 클릭해서 크게 보기</span><span class="flyer-collapse-label" data-ko="전단지 접기" data-en="Click to collapse flyer">전단지 접기</span></label></div><div class="partner-modal-actions"><p data-ko="교육 안내를 확인한 후 신청서를 작성해 주세요." data-en="Review the learning information, then complete the request form.">교육 안내를 확인한 후 신청서를 작성해 주세요.</p><a class="btn btn-primary" href="${requestFormUrl}" target="_blank" rel="noopener noreferrer"><span data-ko="교육 신청서 작성" data-en="Complete Learning Request">교육 신청서 작성</span><b>↗</b></a></div></div>`;
