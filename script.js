...
const specialtyPrograms = [
  {id:'digital',titleKo:'하이벨 디지털',titleEn:'Hibelle Digital',operationKo:'직영',operationEn:'DIRECTLY OPERATED',image:'assets/specialty/hibelle-digital.jpg',teacherImage:'assets/teachers/noh-hyekyung.png',teacherKo:'노혜경',teacherEn:'Hyekyung Noh',teacherRoleKo:'디지털 교육 대표 강사',teacherRoleEn:'Lead Digital Instructor',form:'https://docs.google.com/forms/d/1DWtn1FQD86E4EHzABxeoEpHDuVeoFH_Smak4_C1RU7M/viewform',tone:'blue'},
  {id:'english',titleKo:'하이벨 화상영어',titleEn:'Hibelle Online English',operationKo:'직영',operationEn:'DIRECTLY OPERATED',image:'assets/specialty/hibelle-online-english.jpg',teacherImage:'assets/teachers/rachel.png',teacherKo:'하이벨 화상영어 강사진',teacherEn:'Hibelle Online English Team',teacherRoleKo:'1:1 화상영어 전문 강사',teacherRoleEn:'1:1 Online English Instructors',form:'https://docs.google.com/forms/d/1kN5-d09smqU_UO9rUO91SdQqco7ABYDzWTgpv74EUsc/viewform',tone:'orange'},
  {id:'melody',titleKo:'미란멜로디',titleEn:'Meeran Melody',operationKo:'공동운영',operationEn:'CO-OPERATED',image:'assets/specialty/meeran-melody.jpg',teacherImage:'assets/teachers/kim-miran.jpg',teacherKo:'김미란',teacherEn:'Miran Kim',teacherRoleKo:'합창·음악 교육 대표 강사',teacherRoleEn:'Lead Choir & Music Instructor',form:null,tone:'pink'}
];
...
if (oldSpecialtyStart) {
  ...
  specialtyModal.innerHTML = `<div class="specialty-modal-backdrop" data-specialty-close></div><div class="specialty-modal-panel" role="dialog" aria-modal="true" aria-labelledby="specialtyModalTitle"><div class="specialty-modal-head"><div><p>PREMIUM SPECIALTY PROGRAM</p><h2 id="specialtyModalTitle"></h2></div><button type="button" class="specialty-close" data-specialty-close aria-label="닫기">×</button></div><div class="specialty-teacher"><img src="" alt=""><div><span data-ko="대표 강사" data-en="FEATURED INSTRUCTOR">대표 강사</span><h3></h3><p></p></div></div><div class="specialty-modal-scroll"><img class="specialty-modal-image" src="" alt=""><section class="melody-program-list" hidden><div class="melody-program-heading"><span>MEERAN MELODY PROGRAMS</span><h3 data-ko="미란멜로디 프로그램" data-en="Meeran Melody Programs">미란멜로디 프로그램</h3><p data-ko="기관과 모임의 목적에 맞춰 네 가지 프로그램을 준비합니다." data-en="Four programs are prepared for the goals of each organization and group.">기관과 모임의 목적에 맞춰 네 가지 프로그램을 준비합니다.</p></div><div class="melody-program-grid"><article><b>01</b><h4 data-ko="멜로디 한조각 - 작은 위로 콘서트" data-en="A Piece of Melody - A Small Comfort Concert">멜로디 한조각 - 작은 위로 콘서트</h4></article><article><b>02</b><h4 data-ko="멜로디 문화 산책" data-en="Melody Cultural Walk">멜로디 문화 산책</h4></article><article><b>03</b><h4 data-ko="찾아가는 멜로디 워십" data-en="Visiting Melody Worship">찾아가는 멜로디 워십</h4></article><article><b>04</b><h4 data-ko="힐링 멜로디" data-en="Healing Melody">힐링 멜로디</h4></article></div></section></div><div class="specialty-modal-actions"><p data-ko="프로그램 전단지를 확인하고 자세한 상담을 신청해 주세요." data-en="Review the program flyer and request a consultation.">프로그램 전단지를 확인하고 자세한 상담을 신청해 주세요.</p><div><a class="btn btn-primary specialty-form-link" href="#" target="_blank" rel="noopener noreferrer"><span data-ko="신청서 작성" data-en="Complete Application">신청서 작성</span><b>↗</b></a></div></div></div>`;
...
document.querySelectorAll('[data-ad-room]').forEach(button=>button.addEventListener('click',()=>{
  ...
  const registeredCards=room.items.map(item=>`<article class="ad-partner-card"><div class="ad-partner-image"><img src="${item.image}" alt="${item.name} 로고 및 기관명"></div><div class="ad-partner-copy"><span>${room.label}</span><a class="ad-partner-name" href="${item.url}" target="_blank" rel="noopener noreferrer"><h3>${item.name} <b>↗</b></h3></a><p>${item.copy}</p></div></article>`).join('');
