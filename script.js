...
const footerTop=document.querySelector('.footer-top');if(footerTop&&!document.querySelector('.footer-social-panel'))footerTop.insertAdjacentHTML('beforeend',`<div class="footer-social-panel"><div class="footer-social-copy"><span data-ko="새로운 프로그램 소식을 소셜 미디어에서도 만나보세요." data-en="Discover Harmony Link's new programs on social media.">새로운 프로그램 소식을 소셜 미디어에서도 만나보세요.</span></div><nav aria-label="소셜미디어"><a href="https://www.instagram.com/hibelleconsulting/" target="_blank" rel="noopener noreferrer" class="instagram" aria-label="Instagram"><img src="assets/instagram.avif" alt=""></a><a href="https://www.threads.net/@hibelleconsulting" target="_blank" rel="noopener noreferrer" class="threads" aria-label="Threads"><img src="assets/threads.avif" alt=""></a></nav></div>`);
