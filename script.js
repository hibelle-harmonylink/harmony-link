...
if(refreshedContact){
  ...
  refreshedContact.innerHTML=`<div class="contact-simple-head"><p class="eyebrow">GET IN TOUCH</p><h2 data-ko="궁금한 점이 있으신가요?" data-en="Have a question?">궁금한 점이 있으신가요?</h2><p data-ko="프로그램 신청, 강사·업체 참여, 회원 안내와 제휴 문의까지 편하게 연락해주세요." data-en="Contact us about programs, provider participation, membership, or partnerships.">프로그램 신청, 강사·업체 참여, 회원 안내와 제휴 문의까지 편하게 연락해주세요.</p></div><div class="contact-simple-divider" aria-hidden="true"></div><div class="contact-simple-links"><a class="contact-simple-link" href="mailto:hibelle@hibelleconsulting.com"><span class="contact-simple-icon" aria-hidden="true">✉</span><span class="contact-simple-text"><strong>hibelle@hibelleconsulting.com</strong><small data-ko="클릭하여 메일 보내기" data-en="Click to send an email">클릭하여 메일 보내기</small></span></a><a class="contact-simple-link" href="tel:+19296030052"><span class="contact-simple-icon" aria-hidden="true">☎</span><span class="contact-simple-text"><strong>929-603-0052 <span class="contact-flag" role="img" aria-label="USA">🇺🇸</span></strong><small data-ko="클릭하여 전화 연결" data-en="Click to call">클릭하여 전화 연결</small></span></a><a class="contact-simple-link" href="sms:+821097730052"><span class="contact-simple-icon" aria-hidden="true">💬</span><span class="contact-simple-text"><strong>010-9773-0052 <span class="contact-flag" role="img" aria-label="Korea">🇰🇷</span></strong><small data-ko="클릭하여 문자 연결" data-en="Click to Text">클릭하여 문자 연결</small></span></a></div><p class="contact-simple-note" data-ko="접수된 문의는 확인 후 빠르게 답변드립니다." data-en="We will review and respond to your inquiry promptly.">접수된 문의는 확인 후 빠르게 답변드립니다.</p>`;
}
...
function restartAdvertisingCarousel(){window.clearInterval(advertisingCarouselTimer);advertisingCarouselTimer=window.setInterval(()=>{advertisingCarouselIndex=(advertisingCarouselIndex+1)%advertisingCarouselItems.length;renderAdvertisingCarousel();},3800);}
