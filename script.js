...
const footerBottom=document.querySelector('.footer-bottom');if(footerBottom&&!document.querySelector('.footer-social-panel'))footerBottom.insertAdjacentHTML('beforebegin',`<div class="container footer-social-panel"><div class="footer-social-copy"><span data-ko="하모니링크의 새로운 프로그램 소식을<br>소셜미디어에서도 만나보세요." data-en="Discover Harmony Link's new programs<br>on social media.">하모니링크의 새로운 프로그램 소식을<br>소셜미디어에서도 만나보세요.</span></div><nav aria-label="소셜미디어"><a href="https://www.instagram.com/hibelleconsulting/" target="_blank" rel="noopener noreferrer" class="instagram" aria-label="Instagram"><b>◎</b></a><a href="https://www.threads.net/@hibelleconsulting" target="_blank" rel="noopener noreferrer" class="threads" aria-label="Threads"><b>@</b></a></nav></div>`);
