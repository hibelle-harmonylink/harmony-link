...
const partnerResourceSections = [
  ...
  {no:'11',tier:0,icon:'📌',title:'공지사항',copy:'매칭·행사·교육 및 시스템 소식',items:[['신규 기관 모집'],['출강 모집'],['이벤트'],['교육 일정'],['시스템 업데이트']]},
  {no:'12',tier:0,icon:'💬',title:'커뮤니티',copy:'파트너끼리 경험과 정보를 나누는 공간',items:[['질문 게시판'],['강사 후기'],['자료 공유'],['성공 사례']]}
];
if (downloads) {
