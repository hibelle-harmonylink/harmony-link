...
if(communitySection){
  ...
  if(communityHeading){communityHeading.dataset.ko='참여하고 연결되세요';communityHeading.dataset.en='Apply and Connect';communityHeading.textContent=currentLanguage==='ko'?'참여하고 연결되세요':'Apply and Connect';}
