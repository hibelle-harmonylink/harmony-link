...
const adRooms={
  premium:{ko:'프리미엄 광고 업체',en:'Premium Advertisers',label:'PREMIUM ADVERTISER',slots:4,items:[{name:'Yura Kim · High Line Residential',copy:'뉴욕 부동산 에이전트 유라 김<br>좋은 매물 선정부터 계약과 입주까지 함께합니다.<br>연락처 516-390-1383',copyEn:'New York real estate agent Yura Kim<br>Property selection through closing and move-in.<br>Contact 516-390-1383',image:'assets/ads/highline-hl-symbol.png',banner:'assets/ads/highline-residential-ko.png',bannerEn:'assets/ads/highline-residential-ko.png',chatUrl:'https://open.kakao.com/me/hlresy',brokerUrl:'https://www.hlres.com/yura-kim',imageOnly:true},{name:'OrganicOne',copy:'유아동 식품·유기농 건강식품·한국 전통 식품을<br>팰팍과 플러싱 매장에서 만나보세요.<br>연락처 팰팍 201-585-0958 · 플러싱 929-845-0958',copyEn:'Organic children’s foods, health foods, and Korean traditional foods<br>Available in Palisades Park and Flushing.<br>Contact: Palisades Park 201-585-0958 / Flushing 929-845-0958',image:'assets/ads/organic-one/logo-green.png',banner:'assets/ads/organic-one/family-products.png',secondaryBanner:'assets/ads/organic-one/traditional-foods.png',chatUrl:'https://www.instagram.com/organicone_/',brokerUrl:'https://www.organiconestore.com/',imageOnly:true}]},
  community:{ko:'협력 업체',en:'Community Partners',label:'COMMUNITY PARTNER',slots:4,items:[{name:'AALEAC',displayNameKo:'아시안 아메리칸 사법 경찰자문위원회',displayNameEn:'Asian American Law Enforcement Advisory Council',copy:'아시안 커뮤니티와 사법기관의 소통과 협력을 지원합니다.<br>연락처 646-996-8093',copyEn:'Supporting communication and cooperation between Asian American communities and law enforcement.<br>Contact 646-996-8093',url:'https://aaleac.org/',image:'assets/partners/aaleac-shield.png?v=20260720-46'}]},
...
const specialtyPopupCopy={
  digital:{ko:'AI와 스마트폰을 실생활에서 자신 있게 활용하도록 돕는<br>맞춤형 디지털 교육입니다.<br>연락처 929-603-0052',en:'Practical digital education for using AI and smartphones with confidence in daily life.<br>Contact 929-603-0052'},
  english:{ko:'시간과 장소의 제약 없이 수준과 목표에 맞춰 진행하는<br>1:1 실용 화상영어입니다.<br>연락처 929-603-0052',en:'Personalized one-to-one practical English lessons tailored to each learner’s level and goals.<br>Contact 929-603-0052'},
  melody:{ko:'노래·발성·호흡과 다양한 음악 활동으로 마음과 공동체를 잇는<br>힐링 프로그램입니다.<br>연락처 817-905-3468',en:'A healing music program connecting hearts and community through singing, breathing, and music activities.<br>Contact 817-905-3468'}
};
const promotionNews=[
