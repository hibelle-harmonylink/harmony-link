...
const adRooms={
  premium:{ko:'프리미엄 광고 업체',en:'Premium Advertisers',label:'PREMIUM ADVERTISER',slots:4,items:[{name:'Yura Kim · High Line Residential',copy:'뉴욕 부동산 에이전트 유라 김<br>좋은 매물 선정부터 계약과 입주까지 함께합니다. 연락처 516-390-1383',copyEn:'New York real estate agent Yura Kim<br>Property selection through closing and move-in. Call 516-390-1383.',image:'assets/ads/highline-hl-symbol.png',banner:'assets/ads/highline-residential-ko.png',bannerEn:'assets/ads/yura-kim-highline-logo.png',chatUrl:'https://open.kakao.com/me/hlresy',brokerUrl:'https://www.hlres.com/yura-kim',imageOnly:true},{name:'OrganicOne',copy:'유아동 식품·유기농 건강식품·한국 전통 식품을 팰팍과 플러싱 매장에서 만나보세요. 팰팍 201-585-0958 · 플러싱 929-845-0958',copyEn:'Organic children’s foods, health foods, and Korean traditional foods in Palisades Park and Flushing. Palisades Park 201-585-0958 · Flushing 929-845-0958.',image:'assets/ads/organic-one/logo-green.png',banner:'assets/ads/organic-one/family-products.png',secondaryBanner:'assets/ads/organic-one/traditional-foods.png',chatUrl:'https://www.instagram.com/organicone_/',brokerUrl:'https://www.organiconestore.com/',imageOnly:true}]},
