...
function restartAdvertisingCarousel(){window.clearInterval(advertisingCarouselTimer);advertisingCarouselTimer=window.setInterval(()=>{advertisingCarouselIndex=(advertisingCarouselIndex+1)%advertisingCarouselItems.length;renderAdvertisingCarousel();},4500);}
