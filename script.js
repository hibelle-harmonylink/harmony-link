...
const adRooms={
  ...
  community:{ko:'협력 업체',en:'Community Partners',label:'COMMUNITY PARTNER',slots:4,items:[{name:'AALEAC',copy:'업체명을 클릭하면 홈페이지로 이동합니다.',url:'https://aaleac.org/',image:'assets/partners/aaleac-symbol.png'}]},
