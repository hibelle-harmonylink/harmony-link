...
if(communitySection){
  ...
  if(communityCopy){communityCopy.dataset.ko='입점 파트너와 교육 수강자가 목적에 맞는 신청 경로를 선택할 수 있습니다.';communityCopy.dataset.en='Partners and learners can choose the application path that fits their purpose.';communityCopy.textContent=communityCopy.dataset[currentLanguage];}
}
...
if(learnerDescription){learnerDescription.dataset.ko='교회, 학교, 도서관, 시니어센터, 기업, 커뮤니티와 개인까지 원하는 장소에서 맞춤 교육을 신청할 수 있습니다.';learnerDescription.dataset.en='Churches, schools, libraries, senior centers, companies, communities, and individuals can request tailored learning wherever they are.';learnerDescription.textContent=learnerDescription.dataset[currentLanguage];}
...
partnerCenter.querySelector('.partner-center-card').insertAdjacentHTML('beforeend', `<div class="partner-upgrade-guide"><button class="partner-guide-toggle" type="button" aria-expanded="false" aria-controls="partnerGuideDetails"><span><small>PARTNER START GUIDE</small><strong data-ko="로그인부터 파트너 등급 이용까지" data-en="From sign-in to partner access">로그인부터 파트너 등급 이용까지</strong></span><b aria-hidden="true">＋</b></button><div class="partner-guide-details" id="partnerGuideDetails" hidden><p data-ko="아래 순서대로 진행하면 신청과 승인 상태를 쉽게 확인할 수 있습니다." data-en="Follow these steps to apply, receive approval, and access your partner resources.">아래 순서대로 진행하면 신청과 승인 상태를 쉽게 확인할 수 있습니다.</p><ol><li><b>01</b><span data-ko="가입·로그인" data-en="Join or sign in">가입·로그인</span><small data-ko="Google 또는 Kakao 계정으로&lt;br&gt;간편하게 로그인합니다." data-en="Start with Google or Kakao.">Google 또는 Kakao 계정으로<br>간편하게 로그인합니다.</small></li><li><b>02</b><span data-ko="입점 파트너 신청" data-en="Partner application">입점 파트너 신청</span><small data-ko="파트너 신청서를 작성하고&lt;br&gt;필요한 정보를 제출합니다." data-en="Submit a company or instructor application.">파트너 신청서를 작성하고<br>필요한 정보를 제출합니다.</small></li><li><b>03</b><span data-ko="관리자 검토·승인" data-en="Review and approval">관리자 검토·승인</span><small data-ko="승인 후 안내 메일을 통해&lt;br&gt;파트너 이용 방법을 확인합니다." data-en="Receive Free Partner status and an email after approval.">승인 후 안내 메일을 통해<br>파트너 이용 방법을 확인합니다.</small></li><li><b>04</b><span data-ko="등급 선택·변경" data-en="Choose or upgrade tier">등급 선택·변경</span><small data-ko="FREE · BASIC · PREMIUM 중&lt;br&gt;필요한 등급을 선택합니다." data-en="Choose BASIC or PREMIUM as needed.">FREE · BASIC · PREMIUM 중<br>필요한 등급을 선택합니다.</small></li><li><b>05</b><span data-ko="다시 로그인·자료 이용" data-en="Sign in again and access">다시 로그인·자료 이용</span><small data-ko="승인된 파트너는&lt;br&gt;등급별 혜택과 자료를 이용합니다." data-en="Sign in again to access tier resources.">승인된 파트너는<br>등급별 혜택과 자료를 이용합니다.</small></li></ol><div class="partner-guide-actions"><a class="btn btn-primary" href="https://forms.gle/pF4xy5Jz4ycVouKo9" target="_blank" rel="noopener noreferrer"><span data-ko="파트너 신청서 작성" data-en="Apply as a Partner">파트너 신청서 작성</span><b>✓</b></a></div></div></div>`);
...
const footerTop=document.querySelector('.footer-top');if(footerTop&&!document.querySelector('.footer-social-panel'))footerTop.insertAdjacentHTML('beforeend',`<div class="footer-social-panel"><div class="footer-social-copy"><span data-ko="새로운 프로그램 소식을 소셜 미디어에서도 만나보세요." data-en="Discover Harmony Link's new programs on social media.">새로운 프로그램 소식을 소셜 미디어에서도 만나보세요.</span></div><nav aria-label="소셜미디어"><a href="https://www.instagram.com/hibelleconsulting/" target="_blank" rel="noopener noreferrer" class="instagram" aria-label="Instagram"><img src="assets/instagram.svg" alt=""></a><a href="https://www.threads.net/@hibelleconsulting" target="_blank" rel="noopener noreferrer" class="threads" aria-label="Threads"><img src="assets/threads.svg" alt=""></a></nav></div>`);
