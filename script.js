...
const adRooms={
  premium:{ko:'프리미엄 광고 업체',en:'Premium Advertisers',label:'PREMIUM ADVERTISER',slots:4,items:[{name:'Yura Kim · High Line Residential',copy:'프리미엄 광고가 등록되었습니다.',copyEn:'A premium advertisement has been added.',image:'assets/ads/highline-hl-symbol.png',banner:'assets/ads/highline-residential-ko.png',bannerEn:'assets/ads/yura-kim-highline-logo.png',chatUrl:'https://open.kakao.com/me/hlresy',brokerUrl:'https://www.hlres.com/yura-kim',imageOnly:true},{name:'OrganicOne',copy:'유아동 식품·유기농 건강식품·한국 전통 식품을 팰팍과 플러싱 매장에서 만나보세요. 팰팍 201-585-0958 · 플러싱 929-845-0958',copyEn:'Organic children’s foods, health foods, and Korean traditional foods in Palisades Park and Flushing.',image:'assets/ads/organic-one/logo-green.png',banner:'assets/ads/organic-one/family-products.png',secondaryBanner:'assets/ads/organic-one/traditional-foods.png',chatUrl:'https://www.instagram.com/organicone_/',brokerUrl:'https://www.organiconestore.com/',imageOnly:true}]},
