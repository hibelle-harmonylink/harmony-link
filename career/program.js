(function () {
  ...
  var introText = program.shortIntro || (program.duration + ' 과정으로 ' + program.certPrepKo + '을 목표로 합니다.');
  document.getElementById('detailIntro').textContent = introText;

  document.getElementById('detailCtaRow').innerHTML =
    '<a class="career-btn career-btn-primary" href="' + partner.inquiryUrl + '" target="_blank" rel="noopener noreferrer">문의 및 신청하기 ↗</a>' +
    '<a class="career-btn career-btn-outline" href="' + program.officialUrl + '" target="_blank" rel="noopener noreferrer">DMS 공식 과정 보기 ↗</a>';
  ...
  sections.push('<section class="career-detail-section"><h2>과정 소개</h2><p>' + introText + '</p></section>');
  ...
  if (program.audience && program.audience.length) {
    sections.push(
      '<section class="career-detail-section"><h2>이런 분께 추천합니다</h2>' +
  ...
  sections.push(
    '<section class="career-detail-section career-consult-section">' +
    '<h2>상담 안내</h2>' +
    '<p class="career-consult-phone">한국어 상담: ' + partner.phone + '</p>' +
    '<a class="career-btn career-btn-primary" href="' + partner.inquiryUrl + '" target="_blank" rel="noopener noreferrer">문의 및 신청하기 ↗</a>' +
    '</section>'
  );

  sections.push(
    '<section class="career-detail-section career-other-programs">' +
    '<a class="career-text-link" href="' + partnerUrl + '">다른 프로그램 보기</a>' +
    '</section>'
  );
