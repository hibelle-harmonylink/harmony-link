-- Allow administrators to keep a verified human name for each member.
begin;
...
set display_name = '김미란'
from auth.users user_account
where profile.id = user_account.id
  and lower(user_account.email) = 'meeranmelodyny@gmail.com';
...
revoke all on function public.admin_update_member_name(uuid, text) from public;
