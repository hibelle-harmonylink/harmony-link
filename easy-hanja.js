(() => {
  ...
  const entries = [
    ['學','학','배울 학'],['校','교','학교 교'],['文','문','글월 문'],['化','화','될 화'],['國','국','나라 국'],['韓','한','한국 한'],['漢','한','한나라 한'],['字','자','글자 자'],['人','인','사람 인'],['生','생','날 생'],['活','활','살 활'],['家','가','집 가'],['可','가','옳을 가'],['價','가','값 가'],['族','족','겨레 족'],['事','사','일 사'],['四','사','넉 사'],['社','사','모일 사'],['師','사','스승 사'],['愛','애','사랑 애'],['情','정','뜻 정'],['正','정','바를 정'],['政','정','정사 정'],['安','안','편안 안'],['全','전','온전 전'],['保','보','보전할 보'],['護','호','도울 호'],['心','심','마음 심'],['身','신','몸 신'],['體','체','몸 체'],['健','건','굳셀 건'],['康','강','편안 강'],['福','복','복 복'],['幸','행','다행 행'],['希','희','바랄 희'],['望','망','바랄 망'],['時','시','때 시'],['間','간','사이 간'],['年','년','해 년'],['月','월','달 월'],['日','일','날 일'],['今','금','이제 금'],['明','명','밝을 명'],['大','대','큰 대'],['小','소','작을 소'],['中','중','가운데 중'],['高','고','높을 고'],['新','신','새 신'],['用','용','쓸 용'],['理','리','다스릴 리'],['解','해','풀 해'],['知','지','알 지'],['識','식','알 식'],['經','경','지날 경'],['驗','험','시험 험'],['技','기','재주 기'],['術','술','재주 술'],['敎','교','가르칠 교'],['育','육','기를 육'],['書','서','글 서'],['道','도','길 도'],['場','장','마당 장'],['館','관','집 관'],['醫','의','의원 의'],['療','료','병 고칠 료'],['金','금','쇠 금'],['融','융','녹을 융'],['電','전','전기 전'],['話','화','말씀 화'],['友','우','벗 우'],['母','모','어미 모'],['父','부','아비 부'],['子','자','아들 자'],['女','여','여자 여'],['男','남','남자 남'],['老','로','늙을 로'],['樂','락','즐길 락'],['音','음','소리 음'],['美','미','아름다울 미'],['成','성','이룰 성'],['功','공','공 공'],['業','업','업 업']
  ];
  const words = [
    ['학교','學校','배울 학 · 학교 교'],['한자','漢字','한나라 한 · 글자 자'],['가족','家族','집 가 · 겨레 족'],['사랑','愛','사랑 애'],['안전','安全','편안 안 · 온전 전'],['건강','健康','굳셀 건 · 편안 강'],['행복','幸福','다행 행 · 복 복'],['희망','希望','바랄 희 · 바랄 망'],['문화','文化','글월 문 · 될 화'],['교육','敎育','가르칠 교 · 기를 육'],['시간','時間','때 시 · 사이 간'],['정보','情報','알 정 · 뜻 보'],['금융','金融','쇠 금 · 녹을 융'],['전화','電話','전기 전 · 말씀 화'],['인생','人生','사람 인 · 날 생']
  ];
  ...
  const search = () => {
    ...
    const exactWords = words.filter(([hangul, hanja]) => hangul === value || hanja === value)
      .map(([hangul, hanja, meaning]) => ({ character:hanja, reading:hangul, meaning }));
